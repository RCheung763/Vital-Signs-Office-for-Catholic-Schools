...
def handle_special_zip(zipc: str, inst_raw: str, inst_key: str, cands: pd.DataFrame):
    ...
    # ZIP-specific overrides (same as before)…
    if zipc == '98006':
...
# ─────────────────────────────────────────────────────────────────────────────
zip_path    = r'C:\Users\veetr\OneDrive - Seattle University\Capstone Dashboard\Data\Fulcrum TAP Data.zip'
extract_dir = r'C:\Users\veetr\OneDrive - Seattle University\Capstone Dashboard\Data\Fulcrum TAP Data'
raw_dir     = r'C:\Users\veetr\OneDrive - Seattle University\Capstone Dashboard\Data\Fulcrum Raw'
...
# ─────────────────────────────────────────────────────────────────────────────
cleaned_dir = r'C:\Users\veetr\OneDrive - Seattle University\Capstone Dashboard\Data\Fulcrum Cleaned'
...
# 1) Unzip & Merge Yearly Excel → CSV
# ─────────────────────────────────────────────────────────────────────────────
zip_path    = r'C:\Users\veetr\OneDrive - Seattle University\Capstone Dashboard\Data\ulcrum TAP Data.zip'
extract_dir = r'C:\Users\veetr\OneDrive - Seattle University\Capstone Dashboard\Data\Fulcrum TAP Data'
raw_dir     = r'C:\Users\veetr\OneDrive - Seattle University\Capstone Dashboard\Data\Fulcrum Raw'
...
# Power BI will load the DataFrame named final_df as your table.

# ─────────────────────────────────────────────────────────────
# Write the master CSV to Fulcrum Cleaned
# ─────────────────────────────────────────────────────────────
if not final_df.empty:                       # only if there’s data
    master_csv = os.path.join(
        cleaned_dir,
        'fulcrum_all_years_cleaned.csv'      # call it whatever you like
    )
    final_df.to_csv(
        master_csv,
        index=False,
